...
<div class="card pilihMetodePembayaranPage-card">
    ...
    <div class="row justify-content-center pb-5 pt-2">
        <div class="card shadow-lg bg-white">
            ...
            <div class="form-group row">
                <label for="tiketPemesanan" class="col-sm-3 col-form-label">Tiket</label>
                <div class="col-sm-9">
                    <div class="form-control lihat-bukti-pembayaran" data-toggle="modal" data-placement="top" title="Lihat Tiket Pemesanan" data-target="#lihatTiketModal">Lihat tiket</div>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="{{ route('customer.riwayatPemesanan') }}" class="btn btn-secondary" >Keluar</a>
            </div>
